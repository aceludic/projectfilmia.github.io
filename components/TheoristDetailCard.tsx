            ...
            <div className={`transition-all duration-300 ease-in-out ${isOpen ? 'max-h-[2000px]' : 'max-h-0'}`}>
                <div className="p-4 border-t border-glass-border dark:border-glass-border-dark">
                    <div className="space-y-4 text-stone-700 dark:text-stone-300 text-sm">
                        ...
                        <div>
                            <h5 className="font-bold uppercase text-stone-600 dark:text-stone-400 tracking-wider text-xs mb-2">Key Terms</h5>
                            <TermList terms={theorist.keyTerms} />
                        </div>
                        {theorist.additionalTerms && theorist.additionalTerms.length > 0 && (
                            <div>
                                <h5 className="font-bold uppercase text-stone-600 dark:text-stone-400 tracking-wider text-xs mb-2">Additional Terms</h5>
