...
const NewsPage: React.FC = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="max-w-3xl mx-auto text-sm text-stone-600 dark:text-stone-300 bg-beige-200 dark:bg-stone-800 p-4 rounded-lg border border-beige-300 dark:border-stone-700 mb-12 flex items-start space-x-3">
