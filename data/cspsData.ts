    ...
    },
    {
        ...
        csps: [
            ...
            },
            {
                ...
                revisionNotes: [
                    "**Audience Analysis:**",
                    "   - **Henry Jenkins (Fandom Theory):** Taylor Swift's fans, the 'Swifties', are a perfect example of a modern, networked **participatory culture**. They are not passive consumers; they are active creators and detectives. They engage in **textual poaching** by decoding 'Easter eggs' (hidden clues) in her posts, creating elaborate theories, making fan videos, and organising online listening parties. They are a powerful, collective force that significantly influences her brand and the music industry.",
                    "   - **David Gauntlett (Identity Theory):** Swift provides a complex 'toolkit' for her audience to construct their identities. Her lyrical storytelling about personal experiences (love, heartbreak, growth) offers fans resources to navigate their own lives. Fans 'pick and mix' elements of her persona and music to express themselves.",
                    "**Industry Analysis:**",
                    "   - **David Hesmondhalgh (Cultural Industries):** Swift is a master of minimizing risk and maximizing profit. Re-recording her old albums ('Taylor's Version') is a brilliant strategy to regain control of her master recordings, repackaging existing successful content for a new audience. Her direct-to-fan communication via social media and meticulously planned album rollouts are strategies to build hype and ensure massive commercial success, showing how a single artist can operate as a powerful cultural industry in their own right."
                ]
            },
        ]
    }
